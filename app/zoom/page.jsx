    ...
    return (
        <div className='mb-5'>
            ...
            <div className="block md:flex">
                ...
                <div className="col-6 flex md:flex-col justify-center mt-5 md:mt-0 md:ml-[5rem]">
                    <div className="text-[#86868b]">
                        <h3 className='text-2xl'>Up to</h3>
                        <h1 className='text-[#ff791b] lg:text-4xl font-bold'>8x</h1>
                        <h3 className='text-[1.2rem] '>optical-quality zoom</h3>
                    </div>
                    <div className="text-[#86868b] md:mt-4">
                        <h3 className='text-2xl'>All </h3>
                        <h1 className='text-[#ff791b] lg:text-4xl font-bold'>48MP</h1>
                        <h3 className='text-[1.2rem]'>rear cameras</h3>
                    </div>
                </div>
            </div>
        </div>
