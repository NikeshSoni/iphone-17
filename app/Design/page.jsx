    ...
    return (
        <div className='container mx-auto my-6'>
            <div className='text-center text-white  w-[80%] md-w-[60%] mx-auto'>
                <h1 className='text-[#ff791b] text-1xl md:text-3xl my-2'>Design</h1>
                <h1 className='text-1.5xl md:text-4xl xl:text-6xl font-bold'>Unibody enclosure.</h1>
                <h1 className='text-1.5xl md:text-4xl xl:text-6xl font-bold md-mt-2 mt-1'>Makes a strong case for itself.</h1>
